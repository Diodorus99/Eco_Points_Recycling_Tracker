    ...
    private static void logRecyclingEvent() {
        ...
        while (true) {
            try {
                ...
                if ( !( material.equalsIgnoreCase("plastic") || material.equalsIgnoreCase("glass") || 
                material.equalsIgnoreCase("metal") || material.equalsIgnoreCase("paper") ) ) throw new IllegalArgumentException();
                break;  // Exit loop if input is valid
            }  catch (IllegalArgumentException e) {
                System.out.println("Invalid material. Must be either plastic, glass, metal or paper.");
            }
        }
        double weight = 0.0;
        ...
        while (true) {
            try {
                ...
                // Convert input to double        // Check that weight is a positive number
